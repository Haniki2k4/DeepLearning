...
class NeuralNetwork:
    ...
    def train(self, X, y, epochs, learning_rate):
        """
        Huấn luyện mô hình:
        - Chạy feedforward rồi backward trong mỗi epoch.
        - In loss (MSE) định kỳ.
        """
...
# Tạo mạng và huấn luyện
nn = NeuralNetwork(input_size=2, hidden_size=4, output_size=1)
nn.train(X, y, epochs=10000, learning_rate=0.1)

# In dự đoán sau huấn luyện
